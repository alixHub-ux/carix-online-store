...
function Products() {
  ...
  const products: Product[] = [
    ...
    },
    {
      ...
      category: "Materials",
      description: "Laine acrylique de haute qualité pour tous vos projets de crochet(douzaine à 5000f)",
      price: 5000,
      rating: 5,
      image: Laine1
    },
    {
      ...
      name:"Laine en coton",
      category: "Materials",
      description: "Laine en coton douce et résistante (1pelote de 50g à 1000f ==>12 à 10500f)",
      price: 10500,
      rating: 5,
      image: Laine3
    },
